...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (pathname === '/api/generate/from-text' && req.method === 'POST') {
      return await handleGenerateFromText(req, res)
    }
...
async function handleGenerateFromText(req, res) {
  // Similar implementation for text-based generation
  return res.json({ message: 'Text generation not implemented yet' })
}
